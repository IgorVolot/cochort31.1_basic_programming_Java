...
public class Marks {
    public static void main(String[] args) {
        ...
        // найти среднее - надо сложить все элементы массива, потом разделить на его размер
        ...
        System.out.printf("Average mark: %.2f" , averageMark); // ( printF )  и  ( %.2f, )   - функция ограничения в двух знаках после запятой + вывод в печать
